  ...
  },
  {
    ...
    content: () => (
      <>
        ...
        <p>
          We normalize sensitivity across asymmetric network layers using the <strong>Fisher Information Density</strong> <InlineMath math="\rho_F" />. This allows us to identify <strong>critical points</strong> where the <strong>Shannon entropy</strong> of the weight distribution is most sensitive to precision reduction:
        </p>
        ...
        <p>
          where <InlineMath math="\epsilon(\delta)" /> exceeds the <strong>softmax temperature</strong>, resulting in variable aliasing (e.g., the model losing the ability to distinguish between <InlineMath math="x_i" /> and <InlineMath math="x_j" /> in high-dimensional space).
        </p>
  ...
  },
  {
    ...
    content: () => (
      <>
        ...
        <BlockMath math="\mathcal{L}_{total} = \mathcal{L}_{CE} + \lambda_1 \mathcal{L}_{efficiency} + \lambda_2 \mathcal{L}_z + \lambda_3 \mathcal{L}_{entropy}" />
        <p>
